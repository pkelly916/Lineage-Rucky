...
A USB HID Rubber Ducky Script All-In-One tool, modified to enable/disable HID gadget in Lineage Kernel.
...
## Patch
Apply patch to Lineage 16.1 kernel source for Google Pixel. 
