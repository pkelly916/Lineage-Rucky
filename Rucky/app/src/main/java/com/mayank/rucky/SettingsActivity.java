...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static final String PREF_SETTING_HID_ENABLE = "hidEnable";
    public static Boolean darkTheme;
    public static Boolean launchIcon;
    public static Boolean advSecurity;
    public static Boolean hidEnable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hidEnable = settings.getBoolean(PREF_SETTING_HID_ENABLE, false);
